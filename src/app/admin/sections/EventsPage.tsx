...
export default function EventsPage() {
  ...
  const events = Array.from({ length: 20 }).map((_, i) => ({
    ...
    desc: "An exciting event exploring innovation, collaboration, and creativity at XIE.",
  }));
      ...
      >
        <div className="hidden md:block">
          ...
          <p className="text-gray-500 text-sm">
            Manage, view, and explore all registered events of Spandan, Transmission, and Sparx.
          </p>
        </div>
